...
# df_sp, sp_hist, sp_bins, sp_patches = plot_equity_change_distribution(equity='^GSPC', period='max') # plot the S&P distribution
plot_equity_change_distribution(equity='^GSPC', period='max') # plot the S&P distribution